...
namespace GameBoyEmulator.HardwareComponents.CPU.Instructions
{
    public class Instruction
    {
        ...
        public Instruction(InstructionType type, AdressModeType mode = AdressModeType.AM_IMP, RegisterType? register1 = null, RegisterType? register2 = null, ConditionType condition = ConditionType.CT_NONE,byte? parameter=null)
        {
            Type = type;
            Mode = mode;
            Register1 = register1;
